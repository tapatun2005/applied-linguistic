      ...
      <div class="cols">
        ...
        <div class="col f-direction--column f-justify--center m-hidden">
          <div class="img img--intro">
            <img class="" src="@/assets/head-two.png">
          </div>
        </div>
      </div>
      ...
      <section>
        <div class="cols f-align--start">
            ...
            <div class="video">
                ...
                <div class="video__popup">
                  ...
                  <div class="video__popup__frame">
                    <iframe data-src="https://www.youtube.com/embed/gVZhRXhqBcA?autoplay=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
          ...
          <div class="col-3 f-justify--center">
            <article>
              <p>We show you how we analysed this data and then introduce you to some recommendations that we made as a result of our study of the community project data. We ask you to reflect on our recommendations and we suggest that you write a short paragraph about what you might do differently in your second interview. </p>
            ...
            <div class="col">
              <div>
                <div class="book">
                    ...
                    <p>Given that we are now unable to ask our clients about their rationale for the design of their project, we would advise other app lied linguists (including ourselves in future) to discuss the design of a project before it begins, so that project leaders, participants and researchers are, as far as possible, aware of the assumptions behind, and the consequences of, their decisions fro m the very start" (Wicaksono and Zhurauskaya, 2020: 30-33).</p>
        ...
        <div class="cols">
          <div class="col f-justify--center">
            <div class="content">
              ...
              <p>The white text on a green background below is from our book and, again, the page numbers are there in case you want to reference our work.  </p>
          ...
          <div class="cols">
            <div class="col">
              <div class="book">
                  ...
                  <h4>Stage six </h4>
                  <p>Stage six of our study involved extending the analysis made in step four and five by comparing our data with similar or dissimilar examples found in other conversation analysis studies. ten Have (1990) highlights the importance of this stage for conversation analysis researchers, as it allows for the building of a collection of similar extracts to support a systematic comparison" (Wicaksono and Zhurauskaya, 2020: 33-36).  </p>
              ...
              <div>
                ...
                <ul class="reflects">
                  ...
                  <li>
                      <div class="_expand" @click="expand($event)">
                        <div class="_title">
                          <span>What might you do differently when you plan and record your second interview? </span>
                        </div>
                        <div class="_button"></div>
                      </div>
                      <div class="_form">
...
export default {
  components: { Transcription, Dictionary, Tabs },
  name: 'Two',
  mixins: [general],
  data: () => ({
    subject: "Interview | Part 2",
    answers: {
      one: {
