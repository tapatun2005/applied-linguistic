      ...
      <div class="cols">
        ...
        <div class="col f-direction--column f-justify--center m-hidden">
          <div class="img img--intro">
            <img class="" src="@/assets/head-four.png">
          </div>
        </div>
      </div>
        ...
        <div class="cols f-align--start">
          ...
          <div class="col-3 f-justify--center">
            <article>
              ...
              <p>In chapter one of our book, York’s Hidden Stories: Interviews in Applied Linguistics, we asked this question: why interview? In the white text on a green background below, we try and answer the question, and then sort our answers to this question into the four categories listed above. </p>
